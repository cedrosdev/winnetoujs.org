...
class codeDiv_ extends _node_modules_winnetoujs_src_constructos_js__WEBPACK_IMPORTED_MODULE_1__.Constructos {
  ...
  <div id="codeDiv-win-${identifier}" class="codeDiv">
    ...
    <div class="_content">
      ...
      <div class="_code">
        <pre><code class="javascript">${elements_ === null || elements_ === void 0 ? void 0 : elements_.code}</code></pre>
      </div>
    </div>
  </div>
`;
...
class footerWow_ extends _node_modules_winnetoujs_src_constructos_js__WEBPACK_IMPORTED_MODULE_1__.Constructos {
  ...
  <div id="footerWow-win-${identifier}" class="footerWow">
    <div class="btn">Get started ${elements_ === null || elements_ === void 0 ? void 0 : elements_.icon}</div>
  </div>
`;
      },
      /**
...
(async () => {
  ...
  _node_modules_winnetoujs_src_winnetou_js__WEBPACK_IMPORTED_MODULE_0__.Winnetou.select(winnetouLogo.ids.pillar_2).css("visibility", "visible");
  await (0,_node_modules_win_animate_src_animate_js__WEBPACK_IMPORTED_MODULE_3__.anim)(winnetouLogo.ids.pillar_2, "zoomIn");
  _node_modules_winnetoujs_src_winnetou_js__WEBPACK_IMPORTED_MODULE_0__.Winnetou.select(winnetouLogo.ids.pillar_3).css("visibility", "visible");
  await (0,_node_modules_win_animate_src_animate_js__WEBPACK_IMPORTED_MODULE_3__.anim)(winnetouLogo.ids.pillar_3, "zoomIn");
  setTimeout(() => {
    _node_modules_winnetoujs_src_winnetou_js__WEBPACK_IMPORTED_MODULE_0__.Winnetou.select(winnetouLogo.ids.pillar_1).addClass("animation");
    _node_modules_winnetoujs_src_winnetou_js__WEBPACK_IMPORTED_MODULE_0__.Winnetou.select(winnetouLogo.ids.pillar_2).addClass("animation");
    _node_modules_winnetoujs_src_winnetou_js__WEBPACK_IMPORTED_MODULE_0__.Winnetou.select(winnetouLogo.ids.pillar_3).addClass("animation");
  }, 500);
})();
...
let clicks = 0;
let text = _node_modules_winnetoujs_src_winnetou_js__WEBPACK_IMPORTED_MODULE_0__.Winnetou.initMutable(`You clicked me ${clicks} times.`);
let btn = (0,_constructos_homeBody_js__WEBPACK_IMPORTED_MODULE_4__.buttonSnippet)({
  buttonText: {
    mutable: text
  },
  onclick: _node_modules_winnetoujs_src_winnetou_js__WEBPACK_IMPORTED_MODULE_0__.Winnetou.fx(() => {
    clicks++;
    _node_modules_winnetoujs_src_winnetou_js__WEBPACK_IMPORTED_MODULE_0__.Winnetou.setMutable(text, `You clicked me ${clicks} times.`);
  })
 ...
 * @param {string} class_ Set class name to toggle
 */
const toggleBg = class_ => _node_modules_winnetoujs_src_winnetou_js__WEBPACK_IMPORTED_MODULE_0__.Winnetou.select(code3).toggleClass(class_);
(0,_constructos_homeBody_js__WEBPACK_IMPORTED_MODULE_4__.buttonSnippet)({
  buttonText: "Change my color",
  onclick: _node_modules_winnetoujs_src_winnetou_js__WEBPACK_IMPORTED_MODULE_0__.Winnetou.fx(() => toggleBg("alt"))
}).create(code3);

// ------------------------

(0,_constructos_homeBody_js__WEBPACK_IMPORTED_MODULE_4__.footer)().create("#app");
})();
