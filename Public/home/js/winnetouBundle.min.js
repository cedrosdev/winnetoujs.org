...
/* harmony export */ });
/* harmony import */ var _win_config_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../win.config.json */ "./win.config.json");
...
class Winnetou_ {
  ...
  async updateTranslations(class_) {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      let This = class_;
      if (!(_win_config_json__WEBPACK_IMPORTED_MODULE_0__ !== null && _win_config_json__WEBPACK_IMPORTED_MODULE_0__ !== void 0 && _win_config_json__WEBPACK_IMPORTED_MODULE_0__.publicPath)) {
        ...
        _win_config_json__WEBPACK_IMPORTED_MODULE_0__.publicPath = "";
      }
      if (_win_config_json__WEBPACK_IMPORTED_MODULE_0__.publicPath === "/") _win_config_json__WEBPACK_IMPORTED_MODULE_0__.publicPath = "";
      let defaultLang = _win_config_json__WEBPACK_IMPORTED_MODULE_0__ === null || _win_config_json__WEBPACK_IMPORTED_MODULE_0__ === void 0 ? void 0 : _win_config_json__WEBPACK_IMPORTED_MODULE_0__.defaultLang;
      let localLang = window.localStorage.getItem("lang");
      if (localLang) defaultLang = localLang;
      let data;
      try {
        data = await get(`${_win_config_json__WEBPACK_IMPORTED_MODULE_0__.publicPath}/translations/${defaultLang}.json`);
      } catch (e) {
        console.warn(`Lang error. Reloading...


The file '${_win_config_json__WEBPACK_IMPORTED_MODULE_0__.publicPath}/translations/${defaultLang}.json' was not found. Did you set publicPath in win.config.json and created json translation file?`);
...
function highlightCode(code) {
  ...
  const escapedKeys = Object.keys(keys).map(key => escapeRegExp(key)
  // key.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&")
  );
  const keysRegex = new RegExp(`(${escapedKeys.join("|")})`, "g");
  code = code.replace(keysRegex, match => `<span class="${keys[match]}">${match}</span>`);

  // Step 3: Restore strings with span elements
  code = code.replace(/___STRING(\d+)___/g, (_, index) => `<span class="string">${strings[index]}</span>`);
  return code;
}
...
class logo_ extends _node_modules_winnetoujs_src_constructos_js__WEBPACK_IMPORTED_MODULE_1__.Constructos {
  ...
  constructo = (options, oldOptions) => {
    var _options;
    if (!((_options = options) !== null && _options !== void 0 && _options.identifier) && oldOptions !== null && oldOptions !== void 0 && oldOptions.identifier) {
      options = oldOptions;
    }
    let elements = {};
    let identifier = this._mutableToString(options);
...
/* harmony export */   extensionCard: () => (/* binding */ extensionCard),
...
class extensionCard_ extends _node_modules_winnetoujs_src_constructos_js__WEBPACK_IMPORTED_MODULE_1__.Constructos {
  // ========================================
  /**
   * 
   * @param {object} elements
  ...
  <div id="extensionCard-win-${identifier}" class="extensionCard">
    ...
    <div class="_right">
      ...
      <div class="_text">
        ...
        <div class="_install">
          <button onclick="${elements_ === null || elements_ === void 0 ? void 0 : elements_.onclickInstall}">Install</button>
        </div>
      </div>
...
class footer_ extends _node_modules_winnetoujs_src_constructos_js__WEBPACK_IMPORTED_MODULE_1__.Constructos {
  ...
  <div id="footer-win-${identifier}" class="footer">
    <span>Copyright &copy; 2017-${elements_ === null || elements_ === void 0 ? void 0 : elements_.year} Cedros Development</span>
...
const extensionCard = new extensionCard_().constructo;
const footer = new footer_().constructo;

/***/ }),

/***/ "./src/constructos/wow.js":
/*!********************************!*\
  !*** ./src/constructos/wow.js ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class navbar_ extends _node_modules_winnetoujs_src_constructos_js__WEBPACK_IMPORTED_MODULE_1__.Constructos {
  ...
  constructo = (options, oldOptions) => {
    var _options2;
    if (!((_options2 = options) !== null && _options2 !== void 0 && _options2.identifier) && oldOptions !== null && oldOptions !== void 0 && oldOptions.identifier) {
      options = oldOptions;
    }
    let elements = {};
    let identifier = this._mutableToString(options);
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"./node_modules/winnetoujs/schemas/win.config.schema.json","constructosPath":"./constructos","constructosOut":"./src/constructos","publicPath":"/","apps":[{"entry":"./src/app.js","out":"../Public/home/js"}],"sass":[{"entryFolder":"./sass","outFolder":"../Public/home/css"},{"entryFolder":"./sass_docs","outFolder":"../Public/docs/css"}]}');
...
/* harmony import */ var _constructos_animation_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./constructos/animation.js */ "./src/constructos/animation.js");
/* harmony import */ var _constructos_wow_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./constructos/wow.js */ "./src/constructos/wow.js");
...
/* harmony import */ var _constructos_homeBody_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./constructos/homeBody.js */ "./src/constructos/homeBody.js");
/* harmony import */ var _code_highlighter_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./code_highlighter.js */ "./src/code_highlighter.js");
/* harmony import */ var _constructos_icons_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./constructos/_icons.js */ "./src/constructos/_icons.js");
...
(0,_constructos_homeBody_js__WEBPACK_IMPORTED_MODULE_4__.extensionCard)({
  onclickInstall: winnetoujs__WEBPACK_IMPORTED_MODULE_0__.Winnetou.fx(() => {
    window.open("https://marketplace.visualstudio.com/items?itemName=cedros-development.winnetoujs-vscode-framework");
  })
}).create("#app");
